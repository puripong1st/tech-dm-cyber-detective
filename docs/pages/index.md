...
### 🔹 Step 4: แท็บศูนย์รวมคู่มือระบบและเอกสาร README.md (Docs & README Hub)
ผู้เรียนและครูสามารถคลิกแท็บ **"5. คู่มือ & เอกสารระบบ (README)"** จากแถบ Filter หรือกดปุ่มบน Navbar เพื่อเข้าสู่ศูนย์รวมคู่มือ 12 ระบบ, ผังสถาปัตยกรรม AI และเกณฑ์รูบริกได้ทันทีจากหน้าแรก

![Docs & README Section](../../assets/screenshots/index/04_docs_readme_section.png)
*ภาพที่ 4: หน้าต่างแสดงเอกสารคู่มือระบบ (README.md) และสารบัญเจาะลึก 12 หน้า .md บนหน้าแรก*
