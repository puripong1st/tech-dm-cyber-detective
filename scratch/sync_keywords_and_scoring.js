...
const newLocalEvalFn = `        // --- Robust Local Single Role Evaluation Fallback ---
        function localSingleRoleEvaluation(caseItem, roleKey, answer) {
            ...
            if (roleKey === 'legal') {
                ...
                if (score >= 9) {
                    feedback = 'ข้อเสนอแนะด้านวิศวกรรมความปลอดภัยยอดเยี่ยม! เครื่องมือและมาตรการที่เลือกใช้สามารถปิดช่องโหว่ความเสี่ยงของคดีนี้ในระยะยาวได้อย่างสมบูรณ์แบบ';
                } else if (score >= 6) {
                    feedback = 'มีแนวคิดการป้องกันที่ดีแล้ว หากระบุชื่อเครื่องมือเทคโนโลยีความปลอดภัยเฉพาะทาง (เช่น 2FA, SSL, Firewall, Read-Only, SafeSearch) จะทำให้มาตรการรัดกุมยิ่งขึ้น';
                } else {
                    feedback = 'มาตรการป้องกันที่เสนอยังไม่ตรงกับช่องโหว่ความเสี่ยงของคดีนี้ ลองวิเคราะห์จุดผิดพลาดของระบบแล้วเลือกเทคโนโลยีป้องกันที่เหมาะสม';
                }
            }
