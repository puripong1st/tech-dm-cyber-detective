...
| ⚡ **Cyber Shield Detective (ภารกิจรายบุคคล 1 คดี)** | [`/cyber_shield_detective_3.html`](https://tech-dm-cyber-detective.vercel.app/cyber_shield_detective_3.html) | [📖 `cyber_shield_detective_3.md`](docs/pages/cyber_shield_detective_3.md) | นักเรียน ม.3 | เกมสืบคดีรายบุคคล 1 คดี พร้อมส่งคะแนนสด (30 คะแนน) |
| 📝 **แบบทดสอบกฎหมายดิจิทัล** | [`/law_quiz.html`](https://tech-dm-cyber-detective.vercel.app/law_quiz.html) | [📖 คู่มือตั้งค่า Supabase](docs/SUPABASE_LAW_QUIZ_SETUP.md) | นักเรียน ม.3 | สุ่ม 10 ข้อจากคลัง 30 ข้อ ตาม Bloom’s Taxonomy และบันทึกคะแนนรายบุคคล |
...
| 📋 **Law Quiz 30 ข้อ & เฉลยละเอียด** | [`/law_quiz_reference.html`](https://tech-dm-cyber-detective.vercel.app/law_quiz_reference.html) | [📖 `law_quiz_reference.html`](law_quiz_reference.html) | ครูผู้สอน / นักเรียน | คลังข้อสอบ พ.ร.บ.คอมพิวเตอร์ 30 ข้อ ตาม Bloom's Taxonomy พร้อมระบบปลดล็อกเฉลยและพิมพ์ PDF |
...
8. **[กระดานสร้างใบงาน PDPA Canvas (`docs/pages/pdpa_assignment_board.md`)](docs/pages/pdpa_assignment_board.md)** - คู่มือสตูดิโอสร้างใบงานออนไลน์สไตล์ Canva ลากวางสติกเกอร์ และส่งงานเป็น PDF A4
